# ParkiCup · Instagram içerik takvimi (4 hafta, haftada 3 paylaşım)

Üç seri dönüşümlü gider. Her paylaşımın TR ve EN açıklaması `posts.json` içinde;
görseller `site/assets/` ve `site/media/` klasörlerinden gelir.

| Seri | Amaç | Ton |
|---|---|---|
| **Anla** (Understand) | Parkinson'ın ellere etkisini sade dille anlatmak | Bilgilendirici, kaynak gösteren |
| **Uyarla** (Adapt) | Bugün uygulanabilir küçük ipuçları | Pratik, kısa |
| **Yapım** (Making) | ParkiCup'ın tasarım ve üretim süreci | Samimi, perde arkası |

| Hafta | Gün | Seri | Başlık | Görsel |
|---|---|---|---|---|
...
## Kural
- Tıbbi iddia yok: "azaltır", "tedavi eder" yerine "dengede tutar", "kolaylaştırır".
- Her "Anla" paylaşımı bir kaynağa işaret eder (Parkinson's Foundation, EPDA vb.).
- Her paylaşım tek bir fikir anlatır; başlık 8 kelimeyi geçmez.
